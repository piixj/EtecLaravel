        ...
        <div class="w3-justify">
          ...
          <div id="demo2" style="display:none">
            <div class="w3-row">
              <hr>
              <div class="w3-col l2 m3">
                <img src="https://www.w3schools.com/w3images/runway.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
    ...
    <div class="w3-col l4">
      ...
      <div class="w3-white w3-margin">
        ...
        <div class="w3-row-padding w3-white">
          ...
          <div class="w3-col s6">
            <p><img src="https://www.w3schools.com/w3images/team1.jpg" alt="Men in Hats" style="width:100%" class="w3-grayscale"></p>
...
<footer class="w3-container w3-dark-grey" style="padding:32px">
  ...
  <p>Powered by <a href="https://www.w3schools.com/w3images/team4.jpg" target="_blank">w3.css</a></p>
</footer>
